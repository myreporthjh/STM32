...
void DOTMATRIX(void *argument);
void ELEVATOR(void *argument);
...
extern void elevator_move(int photo_num);
...
// 1. move from Driver/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c
...
//    buzzer_main();
  ...
  /* creation of Task1 */
  Task1Handle = osThreadNew(DOTMATRIX, NULL, &Task1_attributes);

  /* creation of TASK2 */
  TASK2Handle = osThreadNew(ELEVATOR, NULL, &TASK2_attributes);
...
/* USER CODE BEGIN Header_DOTMATRIX */
/**
* @brief Function implementing the Task1 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_DOTMATRIX */
void DOTMATRIX(void *argument)
{
  /* USER CODE BEGIN DOTMATRIX */
  /* Infinite loop */
  for(;;)
  {
	dotmatrix_main_test();
  ...
  /* USER CODE END DOTMATRIX */
}

/* USER CODE BEGIN Header_ELEVATOR */
/**
* @brief Function implementing the TASK2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ELEVATOR */
void ELEVATOR(void *argument)
{
  /* USER CODE BEGIN ELEVATOR */
  /* Infinite loop */
  for(;;)
  {
	elevator_main();
